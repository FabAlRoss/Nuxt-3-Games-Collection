<template>
  <PerfectScrollBar
    class="flex flex-wrap justify-center rounded-md h-5/6 px-16 py-8 bg-white/75"
  >
    <div class="">
      <h1><strong>Datenschutz&shy;erkl&auml;rung</strong></h1>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      ...
      <p>&nbsp;</p>
      <h3><strong>Auskunft, Berichtigung und L&ouml;schung</strong></h3>
      <p>
